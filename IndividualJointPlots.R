...
stanfit_joint <- stan("joint_fit3.stan",data=standatajoint,iter=4000,warmup=2000)
...
for(i in c(5,6,7)){
  ...
  standata <- list(N=N,yobs=yobs,yerr1=yerr1,yerr2=yerr2,xobs=xobs,xerr=xerr,iter=4000,warmup=2000)
